...
// ✅ Format content safely with preserved line breaks
$raw_content = $page['content'] ?? '';
$display_content = trim($raw_content) !== '' 
    ? nl2br($raw_content)   // Preserves line breaks for plain text
    : "<p class='text-slate-400 italic'>No content has been added yet. Please update this page in the admin panel.</p>";
?>
<!DOCTYPE html>
