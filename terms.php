...
// ✅ Securely fetch Terms & Conditions page content
$slug = 'terms';
...
// ✅ Format content: preserve line breaks if admin used plain text
$raw_content = $page['content'] ?? '';
$display_content = trim($raw_content) !== ''
    ? nl2br($raw_content) // converts new lines to <br>
    : "<p class='text-slate-400 italic'>No Terms & Conditions content has been added yet. Please update this page in the admin panel.</p>";
?>
<!DOCTYPE html>
...
<header class="bg-slate-900 border-b border-slate-800 fixed top-0 left-0 right-0 z-30">
  <div class="container mx-auto px-4 flex items-center justify-between h-16">
    ...
    <nav class="hidden md:flex gap-6">
      ...
      <a href="terms.php" class="text-primary font-semibold">Terms</a>
    </nav>
  </div>
</header>
